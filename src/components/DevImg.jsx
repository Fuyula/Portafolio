...
import '../styles/components/dev_img.scss'

export const DevImg = ({ height = "auto", width = "auto"}) => {
    return (
        <svg 
            ...
            <path 
                ...
                transform="translate(-114.4741 -135.80928)" 
                className='overallColor' /*overall*/
            />
            <path 
